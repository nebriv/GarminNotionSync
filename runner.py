...
try:
    ...
    M_METRICS = Gauge("gns_last_run_metrics", "Activities with physiology metrics computed in the last run")
    ...
    M_METRICS_TOTAL = Counter("gns_metrics_total", "Total activities with metrics computed")
